function dan_num(varargin)
% -------------------------------------------------------------------------
%prepare the data
% -------------------------------------------------------------------------

load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\fea_video_train.mat');
fea_video_train=reshape(fea_video_train,[1,1,size(fea_video_train,1),size(fea_video_train,2)]);
load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\labels_video_train.mat') ;
...
num_train=size(fea_video_train,4);

load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\fea_video_val.mat');
fea_video_val=reshape(fea_video_val,[1,1,size(fea_video_val,1),size(fea_video_val,2)]);
load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\labels_video_val.mat') ;
...
num_val=size(fea_video_val,4);

imdb.meta.sets={'train','val'};
imdb.images.data=single(cat(4, fea_video_train, fea_video_val));
...
save('exp\dan_3\dan_3.mat', '-struct', 'net') ;
...
net = load('exp\dan_3\dan_3.mat') ;

% Load the test data
load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\fea_video_test.mat');
fea_video_test=reshape(fea_video_test,[1,1,size(fea_video_test,1),size(fea_video_test,2)]);
load('C:\Study\Research\Computer Vision\Introduction to Computer Vision\Project\Data\num_ext_frames\3\labels_video_test.mat') ;

test_data = single(fea_video_test);
...
test_pred=test_pred';
csvwrite('exp\dan_3\result_dan_3.csv',test_pred);
